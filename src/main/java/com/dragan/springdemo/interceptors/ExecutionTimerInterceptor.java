...
public class ExecutionTimerInterceptor implements HandlerInterceptor {
    ...
    long AFTER_COMPLITION_TIME = 0;
    

    @Override
    public void afterCompletion(HttpServletRequest arg0, HttpServletResponse arg1, Object arg2, Exception arg3)
	    throws Exception {
	AFTER_COMPLITION_TIME = System.currentTimeMillis();
	LOGGER.info("Info message: AFTER_COMPLITION_TIME = " +AFTER_COMPLITION_TIME);
	long HANDLER_EXECUTION_TIME = POSTHANDLE_TIME - PREHANDLE_TIME;
	long TOTAL_EXECUTION_TIME = AFTER_COMPLITION_TIME -PREHANDLE_TIME;
